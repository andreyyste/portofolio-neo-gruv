...
export const HeroMobile: React.FC = () => {
    ...
    return (
        <section id="hero" className="w-full bg-[#f4f1ea] px-4 pt-12 pb-16 flex flex-col relative overflow-hidden">
            ...
            <p className="font-body-lg text-[16px] text-on-surface mb-10 max-w-[90%] z-10 font-medium">
                {heroData.tagline}
            </p>

            <div className="relative w-full aspect-square border-[6px] border-on-surface bg-[#1a4a4f] z-10 overflow-hidden flex items-center justify-center">
